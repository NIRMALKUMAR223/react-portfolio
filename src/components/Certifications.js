...
function Certifications() {
  ...
  const certifications = [
    ...
    { name: 'MERN BootCamp', issuer: 'NoviTech', logo: `${process.env.PUBLIC_URL}/images/mern.jpeg` },
    ...
    { name: 'MERN Development', issuer: 'Jspiders', logo: `${process.env.PUBLIC_URL}/images/MernStack.jpeg` },
  ];
